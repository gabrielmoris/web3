...
https://tldrlegal.com/license/apache-license-2.0-(apache-2.0)
    ...
    This instructions are to use the project (Token creation) in order to buy in the NFT project. for that I will hace to run this steps inside the project **token creation**
